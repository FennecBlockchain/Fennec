    ...
    m_network_style(networkStyle)
{
    ...
    unitDisplayControl->setStyleSheet("QLabel { background-color: #0B0B0B; font-weight:bold; text-align:center; font-family: Arial, sans-recif; font-size: 9px; text-transform: uppercase; color: #A5A5A5;} QLabel::item:selected { background-color: #232323;} QLabel::item:pressed { background-color: #232323;}");
...
#else
    	toolbar->setStyleSheet("QToolBar { border-image: url(:/icons/toptoolbar) 0 0 0 0 stretch stretch; min-height: 50px; }  QToolButton:!hover { min-height: 50px; min-width: 160px; font-weight:normal; font-family: Arial, sans-recif; font-size: 11px; text-transform: uppercase; color: #DCDCDC; background-color: rgba(100, 100, 100, 0); margin-left:22px; margin-right:22px; } QToolButton:hover { min-height: 50px; min-width: 160px; font-weight:normal; font-family: Arial, sans-recif; font-size: 11px; text-transform: uppercase; color: #DCDCDC; background-color: rgba(100, 100, 100, 0.1); margin-left:22px; margin-right:22px; } ");
#endif
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Fennec network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
