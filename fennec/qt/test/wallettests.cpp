...
//
//     QT_QPA_PLATFORM=xcb     fennec/qt/test/test_fennec-qt  # Linux
//     QT_QPA_PLATFORM=windows fennec/qt/test/test_fennec-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   fennec/qt/test/test_fennec-qt  # macOS
void TestGUI()
{
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: fennec:")) != -1);
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_fennec-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI();
