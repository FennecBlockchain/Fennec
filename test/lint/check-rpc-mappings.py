...
SOURCES = [
    "fennec/rpc/server.cpp",
    "fennec/rpc/blockchain.cpp",
    "fennec/rpc/mining.cpp",
    "fennec/rpc/misc.cpp",
    "fennec/rpc/net.cpp",
    "fennec/rpc/rawtransaction.cpp",
    "fennec/wallet/rpcwallet.cpp",
]
# Source file (relative to root) containing conversion mapping
SOURCE_CLIENT = 'fennec/rpc/client.cpp'
