...
FALSE_POSITIVES = [
    ("fennec/dbwrapper.cpp", "vsnprintf(p, limit - p, format, backup_ap)"),
    ("fennec/index/base.cpp", "FatalError(const char* fmt, const Args&... args)"),
    ("fennec/netbase.cpp", "LogConnectFailure(bool manual_connection, const char* fmt, const Args&... args)"),
    ("fennec/util/system.cpp", "strprintf(_(COPYRIGHT_HOLDERS).translated, COPYRIGHT_HOLDERS_SUBSTITUTION)"),
    ("fennec/wallet/wallet.h",  "WalletLogPrintf(std::string fmt, Params... parameters)"),
    ("fennec/wallet/wallet.h", "LogPrintf((\"%s \" + fmt).c_str(), GetDisplayName(), parameters...)"),
    ("fennec/logging.h", "LogPrintf(const char* fmt, const Args&... args)"),
]
