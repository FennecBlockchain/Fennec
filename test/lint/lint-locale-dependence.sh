...
export LC_ALL=C
KNOWN_VIOLATIONS=(
    "fennec/bitcoin-tx.cpp.*stoul"
    "fennec/bitcoin-tx.cpp.*trim_right"
    "fennec/dbwrapper.cpp.*stoul"
    "fennec/dbwrapper.cpp:.*vsnprintf"
    "fennec/httprpc.cpp.*trim"
    "fennec/init.cpp:.*atoi"
    "fennec/qt/rpcconsole.cpp:.*atoi"
    "fennec/rest.cpp:.*strtol"
    "fennec/test/dbwrapper_tests.cpp:.*snprintf"
    "fennec/torcontrol.cpp:.*atoi"
    "fennec/torcontrol.cpp:.*strtol"
    "fennec/util/strencodings.cpp:.*atoi"
    "fennec/util/strencodings.cpp:.*strtol"
    "fennec/util/strencodings.cpp:.*strtoul"
    "fennec/util/strencodings.h:.*atoi"
    "fennec/util/system.cpp:.*atoi"
)

REGEXP_IGNORE_EXTERNAL_DEPENDENCIES="^fennec/(crypto/ctaes/|leveldb/|secp256k1/|tinyformat.h|univalue/)"
