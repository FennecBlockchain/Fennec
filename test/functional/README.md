...
- `/fennec/rpc/*` for RPCs
- `/fennec/wallet/rpc*` for wallet RPCs
- `ProcessMessage()` in `/fennec/net_processing.cpp` for parsing P2P messages
...
with fennecd(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a fennecd.  `P2PInterface`
...
Basic code to support P2P connectivity to a fennecd.
