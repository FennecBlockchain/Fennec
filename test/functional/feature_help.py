...
"""Verify that starting fennec with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fennec with -h for help text")
        ...
        self.log.info("Start fennec with -version for version information")
        ...
        self.log.info("Start fennecd with -fakearg to make sure it does not start")
