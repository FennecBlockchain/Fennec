...
A script to format unified git diffs according to [.clang-format](../../fennec/.clang-format).
...
Run this script from the root of the source tree (`fennec/`) to find circular dependencies in the source code.
