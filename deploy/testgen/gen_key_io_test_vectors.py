...
Usage:
    PYTHONPATH=../../test/functional/test_framework ./gen_key_io_test_vectors.py valid 50 > ../../fennec/test/data/key_io_valid.json
    PYTHONPATH=../../test/functional/test_framework ./gen_key_io_test_vectors.py invalid 50 > ../../fennec/test/data/key_io_invalid.json
'''
...
bech32_templates = [
  ...
  ('"fennec',    0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('"fennec',    0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('"fennec',    1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tfennec',    0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tfennec',    0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tfennec',    2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rfennec',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rfennec',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rfennec', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tfennec',   17, 32, False, False, False),
  ('rfennec',  3,  1, False, False, False),
  ('fennec',   15, 41, False, False, False),
  ('tfennec',    0, 16, False, False, False),
  ('rfennec',  0, 32, True,  False, False),
  ('fennec',    0, 16, True,  False, False),
  ('tfennec',    0, 32, False, True,  False),
  ('rfennec',  0, 20, False, False, True)
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['fennec', 'tfennec', 'rfennec']:
